...
_C.MODEL.BACKBONES = 'resnet' # 与detectron2的MODEL》BACKBONE冲突，改为BACKBONES
...
_C.DATASET.DATA_TYPE = None
_C.DATASET.POST_PROCESS = None
...
_C.AUGMENTOR.RESCALE.MIN_SCALE = 0.8
_C.AUGMENTOR.RESCALE.MAX_SCALE = 1.25
